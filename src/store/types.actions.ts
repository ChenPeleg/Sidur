export enum ActionsTypes {
    ...
    /* Import - Export */
    OPEN_IMPORT_SHEETS_MODAL = "OPEN_IMPORT_SHEETS_MODAL",
    CLOSE_IMPORT_SHEETS_MODAL = "CLOSE_IMPORT_SHEETS_MODAL",
    IMPORT_SHEETS_DATA_PASTE = "IMPORT_SHEETS_DATA_PASTE",
    APPROVE_IMPORT_SHEETS_DATA = "APPROVE_IMPORT_SHEETS_DATA",

    OPEN_MY_PROFILE = 'OPEN_MY_PROFILE',
    EXPORT_ALL = 'EXPORT_ALL',
    IMPORT_FILE_UPLOADED = 'IMPORT_FILE_UPLOADED',
    IMPORT_ORDERS_AS_TEXT = 'IMPORT_ORDERS_AS_TEXT',
    OPEN_CLOSE_IMPORT_DIALOG = 'OPEN_CLOSE_IMPORT_DIALOG',
