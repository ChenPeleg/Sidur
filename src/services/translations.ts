...
export const translations = {
    ...
    thisCollectionIsInUsedCannotbeDeleted:
        "לא ניתן למחוק את האוסף או  את המקומות הקיימים בו. ",
    cantDeleteLocation: 'לא ניתן למחוק מיקום המשמש במסלולים / תחב"צ',

    newLocationGroup: "אוסף מיקומים חדש",
    Eshbal: "אשבל",
    NoSketchMessage:
        'לא קיימות סקיצות לסידור, לאחר הזנת כל ההזמנות ניתן ללחוץ על "יצירת סקיצה חדשה"',
    cantEditLocationMessag:
        ' מיקום זה נעול ולא ניתן לערוך אותו, או למחוק אותו. ניתן ליצור עותק שלו על ידי לחיצה על העיפרון ואז "צור עותק". העותק ניתן לעריכה, שינוי ומחיקה',
