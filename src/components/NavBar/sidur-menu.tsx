...
export const SidurMenu = (props: sidurMenuProps) => {
    ...
    return (
        ...
        >
            <MenuItem
                onClick={(e) => handleSidurMenuClick(e, SidurActionType.Rename)}
            >
                <DriveFileRenameOutline />
                &nbsp;
                {translations.Rename}
            ...
            <MenuItem
                onClick={(e) => handleSidurMenuClick(e, SidurActionType.Delete)}
            >
                <Delete />
                &nbsp;
                {translations.Delete}
            ...
            <MenuItem
                onClick={(e) =>
                    handleSidurMenuClick(e, SidurActionType.CreateCopy)
                }
            >
                <FileCopy />
                &nbsp;
            ...
            <MenuItem
                onClick={(e) =>
                    handleSidurMenuClick(e, SidurActionType.Archive)
                }
            >
                <Archive /> &nbsp;
            ...
            <MenuItem
                onClick={(e) =>
                    handleSidurMenuClick(e, SidurActionType.ImportOrders)
                }
            >
                <ImportContacts />
                &nbsp;
            ...
            <MenuItem
                onClick={(e) =>
                    handleSidurMenuClick(e, SidurActionType.ManageSidurim)
                }
            >
                <ListAlt />
                &nbsp;
