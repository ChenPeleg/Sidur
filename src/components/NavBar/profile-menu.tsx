...
export const ProfileMenu = (props: profileMenuProps) => {
    ...
    return (
        ...
        >
            <MenuItem
                onClick={(event) =>
                    handleMenuClose(event, ProfileMenuClickActionType.MyProfile)
                }
            >
                <Person /> &nbsp;{translations.MyProfile}
            </MenuItem>
            <MenuItem
                onClick={(event) =>
                    handleMenuClose(event, ProfileMenuClickActionType.Export)
                }
            >
                <ImportExport /> &nbsp;{translations.ExportToFile}
            </MenuItem>
            <MenuItem
                onClick={(event) =>
                    handleMenuClose(event, ProfileMenuClickActionType.Import)
                }
            >
                <ImportExport />
