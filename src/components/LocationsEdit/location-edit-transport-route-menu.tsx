...
export const RouteTransportEditMenu = (props: LocationEditMenuProps) => {
    ...
    return (
        ...
        >
            <MenuItem
                onClick={(e) =>
                    handleRouteMenuClick(e, RouteOrTransEditAction.RenameRoute)
                }
            >
            ...
            <MenuItem
                onClick={(e) =>
                    handleRouteMenuClick(e, RouteOrTransEditAction.DeleteRoute)
                }
            >
                <Delete />
                &nbsp;
            ...
            <MenuItem
                onClick={(e) =>
                    handleRouteMenuClick(e, RouteOrTransEditAction.CloneRoute)
                }
            >
                <FileCopy />
                &nbsp;
