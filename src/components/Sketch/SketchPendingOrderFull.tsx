...
export const SketchPendingOrderFull = (props: sketchPendingOrderProps) => {
    ...
    const handlePendingOrderMenuClick = (
        event: React.MouseEvent<HTMLElement>,
        clickAction: SketchDriveOrderEditActionEnum
    ) => {
    ...
    const handlePendingOrderMenuOpen = (
        event: React.MouseEvent<HTMLElement>
    ) => {
        ...
        <Box id={"pending-order"}>
            ...
            >
                <Typography variant={"subtitle1"}>
                    {order.Comments +
                        ", " +
                        LanguageUtilities.renderPassengerText(
                            order.passengers
                        )}{" "}
                </Typography>
            </Box>
                    ...
                    <Button
                        ...
                        onClick={(event) =>
                            handlePendingOrderMenuClick(
                                event,
                                SketchDriveOrderEditActionEnum.RemoveFromPending
                            )
                        }
                        variant={"contained"}
                    >
