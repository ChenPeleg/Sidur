...
export const SketchMenu = (props: SketchMenuProps) => {
    ...
    return (
        ...
        >
            <MenuItem
                onClick={(e) =>
                    handleSketchMenuClick(e, SketchActionType.Rename)
                }
            >
                <DriveFileRenameOutline />
                &nbsp;
            ...
            <MenuItem
                onClick={(e) =>
                    handleSketchMenuClick(e, SketchActionType.Delete)
                }
            >
                <Delete />
                &nbsp;
            ...
            <MenuItem
                onClick={(e) =>
                    handleSketchMenuClick(e, SketchActionType.CreateCopy)
                }
            >
                <FileCopy />
                &nbsp;
            ...
            <MenuItem
                onClick={(e) =>
                    handleSketchMenuClick(e, SketchActionType.Archive)
                }
            >
                <Archive /> &nbsp;
